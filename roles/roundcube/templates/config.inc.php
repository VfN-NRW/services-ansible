...
$config['default_host'] = '{{ roundcube_imap_server }}';
...
$config['des_key'] = '{{ lookup('password', 'credentials/' + inventory_hostname + '/roundcube_des_key chars=ascii_letters,digits,punctuation length=24') }}';
...
// Managesieve plugin
$config['managesieve_host'] = '{{ roundcube_managesieve_server }}';

// Password plugin
$config['password_db_dsn'] = 'mysql://{{ roundcube_db_user }}:{{ roundcube_db_pass }}@{{ roundcube_db_host }}/{{ mail_db_name }}';
